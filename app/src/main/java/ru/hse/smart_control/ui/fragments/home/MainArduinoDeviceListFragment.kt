...
class MainArduinoDeviceListFragment : Fragment(), OnRefreshListener, MultipleTypesAdapterKt.OnItemClickListener,
    ...
    override fun onRefresh() {
        lifecycleScope.launch {
            withContext(Dispatchers.Main) {
                hideAllButtons()
                if (!this@MainArduinoDeviceListFragment::multipleTypesAdapter.isInitialized) {
                    initAdapter()
                } else {
