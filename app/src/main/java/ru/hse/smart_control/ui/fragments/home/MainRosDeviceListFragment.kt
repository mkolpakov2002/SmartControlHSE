...
class MainRosDeviceListFragment : Fragment(), OnRefreshListener, MultipleTypesAdapterKt.OnItemClickListener,
    ...
    override fun onRefresh() {
        lifecycleScope.launch {
            withContext(Dispatchers.Main) {
                hideAllButtons()
                if (!this@MainRosDeviceListFragment::multipleTypesAdapter.isInitialized) {
                    initAdapter()
                } else {
